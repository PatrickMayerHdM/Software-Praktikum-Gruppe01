...
--
-- Host: 127.0.0.1    Database: DatingApp_V2
-- ------------------------------------------------------
...
CREATE TABLE `BlockNoteContainsProfile` (
  ...
  CONSTRAINT `BlockNoteContainsProfile_Profile_profile_id_fk` FOREIGN KEY (`profile_id`) REFERENCES `Profile` (`profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Message` (
  ...
  CONSTRAINT `Message_Profile_profile_id_fk` FOREIGN KEY (`sender_id`) REFERENCES `Profile` (`profile_id`),
  CONSTRAINT `Message_Profile_profile_id_fk2` FOREIGN KEY (`recipient_id`) REFERENCES `Profile` (`profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Profile` (
  ...
  KEY `Profile_Account_account_id_fk` (`account_id`),
  ...
  CONSTRAINT `Profile_Account_account_id_fk` FOREIGN KEY (`account_id`) REFERENCES `Account` (`account_id`),
  CONSTRAINT `Profile_BlockNoteContainsProfile_blocknote_id_fk` FOREIGN KEY (`blocknote_id`) REFERENCES `BlockNoteContainsProfile` (`blocknote_id`),
  CONSTRAINT `Profile_FavoriteNoteContainsProfile_favoritenote_id_fk` FOREIGN KEY (`favoritenote_id`) REFERENCES `FavoriteNoteContainsProfile` (`favoritenote_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ProfileContainsInfoObjects`
--

DROP TABLE IF EXISTS `ProfileContainsInfoObjects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ProfileContainsInfoObjects` (
  `profile_id` int NOT NULL,
  `infoobject_id` int NOT NULL,
  PRIMARY KEY (`profile_id`,`infoobject_id`),
  KEY `ProfileContainsInfoObjects_InfoObject_infoobject_id_fk` (`infoobject_id`),
  CONSTRAINT `ProfileContainsInfoObjects_InfoObject_infoobject_id_fk` FOREIGN KEY (`infoobject_id`) REFERENCES `InfoObject` (`infoobject_id`),
  CONSTRAINT `ProfileContainsInfoObjects_Profile_profile_id_fk` FOREIGN KEY (`profile_id`) REFERENCES `Profile` (`profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ProfileContainsMessage` (
  ...
  CONSTRAINT `ProfileContainsMessage_Profile_profile_id_fk` FOREIGN KEY (`profile_id`) REFERENCES `Profile` (`profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-03  8:56:54
