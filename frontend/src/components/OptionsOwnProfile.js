        ...
        <Box sx={{ flexGrow: 1 }}>
          <Grid container
            ...
            <Grid item md={4} xs={6} spacing={2} >
                <button onClick={EditProfile} style={{ height: "200%", width: "100%" ,display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#ef7714", color:"#fff", cursor: "pointer", border: "solid", borderColor: '#BDC2BF'}}>
                    Bearbeiten
                </button>
            </Grid>
          </Grid >
